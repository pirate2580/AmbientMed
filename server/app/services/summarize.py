...
def generate_soap(processed_transcript):
  examples = [
  {
  ...
  texts = text_splitter.create_documents([processed_transcript])
...
#   # Instantiate chain
#   chain = create_stuff_documents_chain(llm, prompt)
#   # processed_transcript = Document(page_content=processed_transcript)
#   # Invoke chain
